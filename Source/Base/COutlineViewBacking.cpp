...
//----------------------------------------------------------------------------------------------------------------------
bool COutlineViewBacking::hasChildren(const CString& itemID) const
//----------------------------------------------------------------------------------------------------------------------
{
	// Setup
	Internals::Item& item = *mInternals->mItemByItemID[itemID];

	return item.mOutlineViewItem->hasChildren();
}
