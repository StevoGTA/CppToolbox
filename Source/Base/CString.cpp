...
//----------------------------------------------------------------------------------------------------------------------
OV<Float32> CString::getOVFloat32() const
//----------------------------------------------------------------------------------------------------------------------
{
	return (!isEmpty() && containsOnly(kCharacterSetFloatingPoint)) ? OV<Float32>(getFloat32()) : OV<Float32>();
}

//----------------------------------------------------------------------------------------------------------------------
OV<Float64> CString::getOVFloat64() const
//----------------------------------------------------------------------------------------------------------------------
{
	return (!isEmpty() && containsOnly(kCharacterSetFloatingPoint)) ? OV<Float64>(getFloat64()) : OV<Float64>();
}
...
//----------------------------------------------------------------------------------------------------------------------
OV<SInt8> CString::getOVSInt8() const
//----------------------------------------------------------------------------------------------------------------------
{
	return (!isEmpty() && containsOnly(kCharacterSetDecimalDigit)) ? OV<SInt8>(getSInt8()) : OV<SInt8>();
}
...
//----------------------------------------------------------------------------------------------------------------------
OV<SInt16> CString::getOVSInt16() const
//----------------------------------------------------------------------------------------------------------------------
{
	return (!isEmpty() && containsOnly(kCharacterSetDecimalDigit)) ? OV<SInt16>(getSInt16()) : OV<SInt16>();
}
...
//----------------------------------------------------------------------------------------------------------------------
OV<SInt32> CString::getOVSInt32() const
//----------------------------------------------------------------------------------------------------------------------
{
	return (!isEmpty() && containsOnly(kCharacterSetDecimalDigit)) ? OV<SInt32>(getSInt32()) : OV<SInt32>();
}
...
//----------------------------------------------------------------------------------------------------------------------
OV<SInt64> CString::getOVSInt64() const
//----------------------------------------------------------------------------------------------------------------------
{
	return (!isEmpty() && containsOnly(kCharacterSetDecimalDigit)) ? OV<SInt64>(getSInt64()) : OV<SInt64>();
}
...
//----------------------------------------------------------------------------------------------------------------------
OV<UInt8> CString::getOVUInt8() const
//----------------------------------------------------------------------------------------------------------------------
{
	return (!isEmpty() && containsOnly(kCharacterSetDecimalDigit)) ? OV<UInt8>(getUInt8()) : OV<UInt8>();
}
...
//----------------------------------------------------------------------------------------------------------------------
OV<UInt16> CString::getOVUInt16() const
//----------------------------------------------------------------------------------------------------------------------
{
	return (!isEmpty() && containsOnly(kCharacterSetDecimalDigit)) ? OV<UInt16>(getUInt16()) : OV<UInt16>();
}
...
//----------------------------------------------------------------------------------------------------------------------
OV<UInt32> CString::getOVUInt32() const
//----------------------------------------------------------------------------------------------------------------------
{
	return (!isEmpty() && containsOnly(kCharacterSetDecimalDigit)) ? OV<UInt32>(getUInt32()) : OV<UInt32>();
}
...
//----------------------------------------------------------------------------------------------------------------------
OV<UInt64> CString::getOVUInt64() const
//----------------------------------------------------------------------------------------------------------------------
{
	return (!isEmpty() && containsOnly(kCharacterSetDecimalDigit)) ? OV<UInt64>(getUInt64()) : OV<UInt64>();
}
