...
class C2DRenderer {
	...
	public:
		...
		virtual	void		strokeLine(const S2DPointF32& startPoint, const S2DPointF32& endPoint,
									bool antiAlias = true, Float32 lineWidth = 1.0) const = 0;
		...
		virtual	void		strokePath(const S2DPath32& path, Float32 lineWidth = 1.0,
