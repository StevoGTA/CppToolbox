...
class CFolderSetup {
	public:
		CFolderSetup()
			{
				CErrorRegistry::registerError(kCFolderDoesNotExistError, CString("Folder Does Not Exist"));
				CErrorRegistry::registerError(kCFolderAlreadyExistsError, CString("Folder Already Exists"));
			}
};
