...
//----------------------------------------------------------------------------------------------------------------------
{
	...
	// Setup bitmap
	CBitmap	bitmap(SBitmapSize(jpegInfo.output_width, jpegInfo.output_height), kBitmapFormatRGB888,
